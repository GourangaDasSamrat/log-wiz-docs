...
<CardGrid>
  <LinkCard title="Getting Started" href="/guides/getting-started/" description="Install and write your first log in under 5 minutes." />
  <LinkCard title="PII Masking" href="/guides/pii-masking/" description="How auto-masking works and how to customise it." />
  <LinkCard title="Configuration" href="/reference/configuration/" description="Every config option documented with types and defaults." />
  <LinkCard title="API Reference" href="/reference/api/" description="Complete method signatures with examples." />
</CardGrid>
